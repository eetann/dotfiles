...
# tree-sitter-cliはnix/home/packages.nixのtree-sitterパッケージで管理するためここでは入れない
PKG_DEFAULT="vscode-langservers-extracted vde-notifier opensrc vde-layout difit portless"
