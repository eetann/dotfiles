...
autocmd vimrc FileType html,css,javascript,javascriptreact,json,vue,sh,dockerfile,typescript,typescriptreact,vim,lua,markdown setlocal sw=2 sts=2 ts=2
