...
全フェーズが終わり、ユーザーの動作確認も終わったら、`./.mywork/changes/YYYY-MM-DD-BRIEF-DESC`から`./.mywork/specs/YYYY-MM-DD-BRIEF-DESC`にディレクトリを移動してね

どのフェーズでも、必要なら AskUserQuestion で曖昧な点・不明点を質問してね。
